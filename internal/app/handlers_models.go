...
func (a *App) meshBytes(r *http.Request) (raw []byte, source string, err error) {
	...
	body, _, err := a.fetcher.get(r.Context(), link, "model/stl,application/octet-stream,*/*", media.MaxSTLBytes)
	if err != nil {
		return nil, "", err
	}
